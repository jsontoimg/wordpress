...
class Jsontoimg {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Jsontoimg_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'JSONTOIMG_VERSION' ) ) {
			$this->version = JSONTOIMG_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'jsontoimg';
	 ...
	 *
	 * - Jsontoimg_Loader. Orchestrates the hooks of the plugin.
	 * - Jsontoimg_i18n. Defines internationalization functionality.
	 * - Jsontoimg_Admin. Defines all hooks for the admin area.
	 * - Jsontoimg_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-jsontoimg-loader.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-jsontoimg-public.php';

		$this->loader = new Jsontoimg_Loader();
	 ...
	 *
	 * Uses the Jsontoimg_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Jsontoimg_i18n();
	 ...
	 *
	 * @since     1.0.0
	 * @return    Jsontoimg_Loader    Orchestrates the hooks of the plugin.
	 */
